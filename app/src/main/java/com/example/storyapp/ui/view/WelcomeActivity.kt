...
class WelcomeActivity : AppCompatActivity() {
    ...
    private fun playAnimation() {
        ...
        val signup = ObjectAnimator.ofFloat(binding.signupButton, View.ALPHA, 1f).setDuration(Constant.DURATION)
        val title = ObjectAnimator.ofFloat(binding.titleTextView, View.ALPHA, 1f).setDuration(Constant.DURATION)
        val desc = ObjectAnimator.ofFloat(binding.descTextView, View.ALPHA, 1f).setDuration(Constant.DURATION)
